import { RotationDirectionType } from '../gamee/objects/player/PaddleHandler';
...
export function rotateLine(lineLength: number, angle: number): Vector2D {
 ...
 * @returns
 */
function flipVectorAroundAngle(angle: number, vector: Vector2D): Vector2D {
